...
Begin VB.Form frmMapInfo 
   ...
   Begin VB.TextBox PVPTxt 
      Appearance      =   0  'Flat
      Height          =   285
      Left            =   2760
      TabIndex        =   15
      Text            =   "0"
      ToolTipText     =   "1 for PVP enabled, 0 for no PVP"
      Top             =   840
      Width           =   255
   End
   Begin VB.TextBox JobTxt 
      Appearance      =   0  'Flat
      Height          =   285
      Left            =   1800
      TabIndex        =   13
      Text            =   "0"
      ToolTipText     =   "1 for job map, 0 for normal map"
      Top             =   840
      Width           =   255
   End
...
Private Sub JobTxt_Change()

    MapInfo.Job = Val(JobTxt.Text)
...
Private Sub PVPTxt_Change()

    MapInfo.PVP = Val(PVPTxt.Text)
