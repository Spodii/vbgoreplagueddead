...
Dim i As Long
    ...
    Const cMessages As String = "2,7,8,12,17,20,24,25,26,29,34,36,37,38,48,49," & _
        "51,57,60,61,64,69,70,79,81,82,83,84,85,97,98,99,101,102,109,111,112,113,114," & _
        "116,119,121,123,125,127,130,131,132,133,137"
    ...
    frmMain.Caption = "Saving client objects..."
    frmMain.Refresh
    Save_ObjsDat
...
Dim CommandID As Byte
    ...
    UserList(Index).BytesIn = UserList(Index).BytesIn + BufUBound + 41
    ...
    If DEBUG_PrintPacketsIn Then Debug.Print "IN: User = " & UserList(Index).Name & "(" & Index & ")" & "  Size = " & BufUBound + 1
    ...
    Do
        ...
        If DEBUG_PrintPacketsIn Then Debug.Print "ID = " & CommandID
        ...
        With DataCode
            ...
            Case .Comm_TalkChannel: Data_Comm_TalkChannel rBuf, Index
            ...
            Case .User_Profile: Data_User_Profile rBuf, Index
            ...
            Case .User_ChannelList: Data_User_ChannelList Index
            ...
            Case .User_JoinChannel: Data_User_JoinChannel rBuf, Index
            Case .User_KnownSkills: Data_User_KnownSkills Index
            Case .User_LeaveChannel: Data_User_LeaveChannel rBuf, Index
