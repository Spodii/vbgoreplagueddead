...
Public Const DegreeToRadian As Single = 0.0174533

'Ignore these values, they are just because the particle engine requires a few variables we dont have
Public Const AcceptEffects As Boolean = True
Public Const WeatherEffectIndex As Long = 0
...
End Type
Public MapData(0 To 1, 0 To 1) As MapBlock
...
Public Sub Engine_Blood_Create(ByVal x As Long, ByVal Y As Long, ByVal Size As Long)
'Empty
End Sub
...
Public Function Engine_SPtoTPY(ByVal x As Long) As Long
Engine_SPtoTPY = 1
End Function
