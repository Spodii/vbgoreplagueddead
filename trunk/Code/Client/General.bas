...
Public NPCTradeItems() As Integer
...
Public Sub Game_SetIcon(ByVal CharIndex As Integer, ByVal ID As Byte, ByVal State As Byte)

'*********************************************
'Set the icon state given the IconID
'*********************************************

    Select Case ID
        Case IconID.CrackArmor
            CharList(CharIndex).CharStatus.CrackArmor = State
        Case IconID.Stun
            CharList(CharIndex).CharStatus.Stun = State
        Case IconID.Berserk
            CharList(CharIndex).CharStatus.Berserk = State
    End Select

End Sub

Public Function Game_StatIDtoDesc(ByVal StatID As Byte) As String

'*****************************************************************
'Returns the stat description given an ID
'*****************************************************************

    Select Case StatID
        Case SID.Accuracy: Game_StatIDtoDesc = "Increases your chance to land a blow with a melee or ranged attack. Majority of skills do not rely on this stat."
        Case SID.Agi: Game_StatIDtoDesc = "Increases the mod value of certain stats."
        Case SID.Armor: Game_StatIDtoDesc = "Allows for usage of better armor and increases the effectiveness of your current armor."
        Case SID.Brave: Game_StatIDtoDesc = "Increases the mod value of certain stats."
        Case SID.DEF: Game_StatIDtoDesc = "Decreases the amount of damage done to you when struck by a physical attack."
        Case SID.Dex: Game_StatIDtoDesc = "Increases the mod value of certain stats."
        Case SID.ELU: Game_StatIDtoDesc = "Experience required for the next level."
        Case SID.ELV: Game_StatIDtoDesc = "Current character level."
        Case SID.Evade: Game_StatIDtoDesc = "Chance to evade an attack completely, taking no damage."
        Case SID.EXP: Game_StatIDtoDesc = "Experience points."
        Case SID.Gold: Game_StatIDtoDesc = "Gold (money)."
        Case SID.Immunity: Game_StatIDtoDesc = "Decreases the amount done to you from offensive magic attacks."
        Case SID.Inte: Game_StatIDtoDesc = "Increases the mod value of certain stats."
        Case SID.MaxHIT: Game_StatIDtoDesc = "Maximum damage for your normal attack (does not include reduction from the target's defense)."
        Case SID.MaxHP: Game_StatIDtoDesc = "Maximum health points."
        Case SID.MaxEP: Game_StatIDtoDesc = "Maximum energy points."
        Case SID.MinHIT: Game_StatIDtoDesc = "Minimum damage for your normal attack (does not include reduction from the target's defense)."
        Case SID.MinHP: Game_StatIDtoDesc = "Current amount of health points."
        Case SID.MinEP: Game_StatIDtoDesc = "Current amount of energy points."
        Case SID.Perception: Game_StatIDtoDesc = "Ability to see cloaked or disguised characters and traps from a farther distance."
        Case SID.Points: Game_StatIDtoDesc = "Amount of points available to spend on stats."
        Case SID.Recov: Game_StatIDtoDesc = "Increases the amount of health points replenished."
        Case SID.Regen: Game_StatIDtoDesc = "Increases the amount of energy points replenished."
        Case SID.Speed: Game_StatIDtoDesc = "Character movement speed (does not affect attack speed or skill exhaust times)."
        Case SID.Str: Game_StatIDtoDesc = "Increases the mod value of certain stats."
        Case SID.Tactics: Game_StatIDtoDesc = "When attack, a portion of your Accuracy moves to Evade, and vise versa when attacking. This increases the amount moved. Note: This will not work against you if attacked at the same time as attacking."
        Case SID.WeaponSkill: Game_StatIDtoDesc = "Allows for usage of better weapons and increase the effectiveness with your current weapon."
        
        'Class-specific stats
        Case SID.Rage: Game_StatIDtoDesc = "Increases the rate that your Rage Counter increases, the maximum value of the counter and how much it affects you."
        Case SID.Rend: Game_StatIDtoDesc = "Increases the chance to cause a bleeding wound on an enemy, and how much the wound affects them. Only works on weapon-based attacks and skills."
        Case SID.Concussion: Game_StatIDtoDesc = "Increases the chance to daze your enemy or give them a concussion, causing them to be stunned for a short period of time."
        Case SID.Bloodlust: Game_StatIDtoDesc = "Increases the amount of health points replenished after killing an enemy."
        
        Case Else: Game_StatIDtoDesc = "Unknown Stat"
        
    End Select

End Function

Public Function Game_StatIDtoName(ByVal StatID As Byte) As String

'*****************************************************************
'Returns the stat name given an ID
'*****************************************************************

    Select Case StatID
        Case SID.Accuracy: Game_StatIDtoName = "Accuracy"
        Case SID.Agi: Game_StatIDtoName = "Agility"
        Case SID.Armor: Game_StatIDtoName = "Armor"
        Case SID.Brave: Game_StatIDtoName = "Bravery"
        Case SID.DEF: Game_StatIDtoName = "Defense"
        Case SID.Dex: Game_StatIDtoName = "Dexterity"
        Case SID.ELU: Game_StatIDtoName = "Experience to level"
        Case SID.ELV: Game_StatIDtoName = "Level"
        Case SID.Evade: Game_StatIDtoName = "Evade"
        Case SID.EXP: Game_StatIDtoName = "Experience"
        Case SID.Gold: Game_StatIDtoName = "Gold"
        Case SID.Immunity: Game_StatIDtoName = "Immunity"
        Case SID.Inte: Game_StatIDtoName = "Intelligence"
        Case SID.MaxHIT: Game_StatIDtoName = "Max Hit"
        Case SID.MaxHP: Game_StatIDtoName = "Max HP"
        Case SID.MaxEP: Game_StatIDtoName = "Max EP"
        Case SID.MinHIT: Game_StatIDtoName = "Min Hit"
        Case SID.MinHP: Game_StatIDtoName = "HP"
        Case SID.MinEP: Game_StatIDtoName = "EP"
        Case SID.Perception: Game_StatIDtoName = "Perception"
        Case SID.Points: Game_StatIDtoName = "Points"
        Case SID.Recov: Game_StatIDtoName = "Recovery"
        Case SID.Regen: Game_StatIDtoName = "Regeneration"
        Case SID.Speed: Game_StatIDtoName = "Speed"
        Case SID.Str: Game_StatIDtoName = "Strength"
        Case SID.Tactics: Game_StatIDtoName = "Tactics"
        Case SID.WeaponSkill: Game_StatIDtoName = "Weapon Skill"
        
        'Class-specific stats
        Case SID.Rage: Game_StatIDtoName = "Rage"
        Case SID.Rend: Game_StatIDtoName = "Rend"
        Case SID.Concussion: Game_StatIDtoName = "Concussion"
        Case SID.Bloodlust: Game_StatIDtoName = "Bloodlust"
        
        Case Else: Game_StatIDtoName = "Unknown Stat"
        
    End Select

End Function

Public Sub MakeStatCosts()

'*****************************************************************
'Generates the stat cost values
'*****************************************************************
Dim i As Long

    'Set the stat costs
    For i = 1 To StatMax
        StatCost(i) = 4.5 * i ^ (1.6 + (0.0006 * i))
    Next i
                            ...
                            If CharList(j).Pos.X < ScreenMaxX Then
                                If CharList(j).Pos.Y > ScreenMinY Then
                                    If CharList(j).Pos.Y < ScreenMaxY Then
                                        ...
                                        TempValue = (TempAngle \ 40)
                                        If TempValue > 4 Then TempValue = 4
                                        TempValue = TempValue + Engine_Distance(CharList(UserCharIndex).Pos.X, CharList(UserCharIndex).Pos.Y, CharList(j).Pos.X, CharList(j).Pos.Y)
...
'***************************************************
    ...
    Select Case InventoryType
        ...
        'User inventory
        Case 1
            If ObjData(UserInventory(ItemIndex).ObjIndex).GrhIndex > 0 Then Game_ClickItem = 1
            
        'Shop inventory
        Case 2
            If ObjData(NPCTradeItems(ItemIndex)).GrhIndex > 0 Then Game_ClickItem = 1
        
        'Bank depot
        Case 3
            If ObjData(UserBank(ItemIndex).ObjIndex).GrhIndex > 0 Then Game_ClickItem = 1
            
    End Select

End Function

Sub Game_LoadObjData()
...
Dim b() As Byte
    ...
    If Dir$(DataPath & "Objs.dat") = vbNullString Then
        MsgBox "Unable to find the objects file!" & vbNewLine & vbNewLine & DataPath & "Objs.dat", vbOKOnly
        IsUnloading = 1
        Exit Sub
    End If
    
    'Decrypt the file
    Encryption_Twofish_DecryptFile DataPath & "Objs.dat", DataPath & "Objs.dat.temp", "1ZXV014!@#)(9487AZXC<>*xv;asfj!)$@"

    'Open the file
    FileNum = FreeFile
    Open DataPath & "Objs.dat.temp" For Binary Access Read As #FileNum
...
Dim TempInt As Integer
    ...
    MapInfo.PVP = MapBuf.Get_Byte
    MapInfo.Job = MapBuf.Get_Byte
    ...
    For Y = 1 To MapInfo.Height
        For X = 1 To MapInfo.Width
            ...
            'Light intensity
            MapData(X, Y).LightIntensity = MapBuf.Get_Byte
